                ...
                <li><a href="telaPrincipal.html">Geral</a></li>
                    ...
                    <div class="main">
                        ...
                        <form>
                            ...
                            <input type="text" id="nome" value="Amanda Xavier">

                            <label for="email">E-mail</label>
                            <input type="email" id="email" value="amanda@gmail.com">

                            <label for="cpf">CPF</label>
                            <input type="text" id="cpf" value="000000000-00">

                            <label for="nascimento">Nascimento</label>
                            <input type="date" id="nascimento" value="2003-03-30">

                            <label for="sexo">Sexo</label>
                            <input type="text" id="sexo" value="Feminino">

                            <label for="contato">Contato</label>
                            <input type="text" id="contato" value="(00) 000000000">
                        </form>
                        </div>
